...
export function FinalCta() {
  return (
    <SectionFrame id="apply" tone="dark" className="scroll-mt-24">
      <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,32rem)] lg:items-start lg:gap-16">
        <div>
          <h2 className="max-w-3xl font-display text-[clamp(2rem,4.6vw,3.4rem)] font-semibold leading-[1.08] tracking-tight">
            {FINAL_CTA.headline}
          </h2>
        ...
        <div className="rounded-4xl bg-white p-6 text-zinc-950 md:p-8">
